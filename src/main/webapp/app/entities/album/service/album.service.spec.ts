...
describe('Album Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Album', () => {
      ...
      service.create(album).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Album', () => {
      ...
      service.update(album).subscribe(resp => (expectedResult = resp));
    ...
    describe('addAlbumToCollectionIfMissing', () => {
      it('should add a Album to an empty array', () => {
        ...
        expect(expectedResult).toEqual([album]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([album, album2]);
      });
