...
describe('Genre Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Genre', () => {
      ...
      service.create(genre).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Genre', () => {
      ...
      service.update(genre).subscribe(resp => (expectedResult = resp));
    ...
    describe('addGenreToCollectionIfMissing', () => {
      it('should add a Genre to an empty array', () => {
        ...
        expect(expectedResult).toEqual([genre]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([genre, genre2]);
      });
