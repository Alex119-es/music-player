...
import { PlayDeleteDialog } from './play-delete-dialog';

describe('Play Management Delete Component', () => {
  let comp: PlayDeleteDialog;
  let fixture: ComponentFixture<PlayDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PlayDeleteDialog);
